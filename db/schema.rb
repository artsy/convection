...
ActiveRecord::Schema.define(version: 2021_11_16_122632) do
  ...
  create_table 'admin_users', force: :cascade do |t|
    ...
    t.index ['gravity_user_id'],
            name: 'index_admin_users_on_gravity_user_id',
            unique: true
  ...
  create_table 'partners', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.string 'name'
    t.index ['gravity_partner_id'],
            name: 'index_partners_on_gravity_partner_id',
            unique: true
  end
